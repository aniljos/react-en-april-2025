...
describe('ListProducts Component', () => {
  ...
  it('should toggle visibility of the test message', () => {
    ...
    expect(screen.queryByText('Page to demonstrate component optimization')).toBeNull();

    // Click to show the message
    fireEvent.click(toggleButton);
    expect(screen.getByText('Page to demonstrate component optimization')).toBeInTheDocument();
  ...
  it('should render products and total price', () => {
    ...
    expect(screen.getByText('Total Prices: 300')).toBeInTheDocument();
  });
